 ...
 *
 * @package WeChat
 * @author skyweo created at 2015/9/24 14:47
 */
class ErrorCode {

    public static function getCodeInfo($content){
        $codeInfo = array(
            -1=>'系统繁忙',
            0=>'请求成功',
        ...
        if(array_key_exists($content['errcode'], $codeInfo)){
            return $codeInfo[$content['errcode']];
        } else {
